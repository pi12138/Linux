...
git clone https://github.com.cnpmjs.org/zsh-users/zsh-autosuggestions.git ~/.oh-my-zsh/custom/plugins/zsh-autosuggestions && echo '下载 zsh-autosuggestions 完成'
git clone https://github.com.cnpmjs.org/zsh-users/zsh-syntax-highlighting.git ~/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting && echo '下载 zsh-syntax-highlighting 完成'
